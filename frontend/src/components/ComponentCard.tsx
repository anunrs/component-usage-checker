...
export default function ComponentCard({
  ...
  return (
    <div
      className={`bg-zinc-900 rounded-xl border border-zinc-800 border-l-4 ${ACCENT[label]} p-4 hover:border-zinc-700 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/30 transition-all duration-200`}
    >
      ...
      <p
        className="text-xs text-zinc-600 font-mono mb-3 truncate"
        title={definedIn}
      >
        {definedIn}
      </p>
