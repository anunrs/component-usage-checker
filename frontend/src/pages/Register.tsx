    ...
    <div className="min-h-screen bg-zinc-950 font-sans flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-zinc-900 rounded-2xl border border-zinc-800 p-8">
          ...
          <p className="text-sm text-zinc-500 mb-6">Start scanning your React projects</p>
        ...
        <p className="text-center text-sm text-zinc-600 mt-5">
          ...
          <Link to="/login" className="text-indigo-400 font-medium hover:text-indigo-300 transition-colors duration-150">
            Sign in
          </Link>
        </p>
      </div>
